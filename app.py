...
.header-menu-lang-row-marker,
.dp-title-company-block-marker,
...
[data-testid="stVerticalBlock"]:has(.header-menu-lang-row-marker) [data-testid="stHorizontalBlock"] {
...
[data-testid="stVerticalBlock"]:has(.header-menu-lang-row-marker) [data-testid="stHorizontalBlock"] > [data-testid="stColumn"] {
    flex: 1 1 0 !important;
    min-width: 0 !important;
}
[data-testid="stVerticalBlock"]:has(.header-menu-lang-row-marker) [data-testid="stButton"] button {
    width: 100% !important;
...
/* ── Generic detail header columns (exclude dedicated action bar) ── */
[data-testid="stVerticalBlock"]:has(.dp-header-marker) [data-testid="stColumns"]:not(:has(.dp-actionbar-wrap-marker)) {
    flex-wrap: nowrap !important;
    gap: 4px !important;
}
[data-testid="stVerticalBlock"]:has(.dp-header-marker) [data-testid="stColumns"]:not(:has(.dp-actionbar-wrap-marker)) > [data-testid="stColumn"] {
    min-width: 0 !important;
    flex-shrink: 1 !important;
}
[data-testid="stVerticalBlock"]:has(.dp-header-marker) [data-testid="stColumns"]:not(:has(.dp-actionbar-wrap-marker)) > [data-testid="stColumn"] > div > div > div > button {
...
@media (max-width: 640px) {
    ...
    [data-testid="stVerticalBlock"]:has(.header-menu-lang-row-marker) {
...
.dp-top-controls-row-marker, .dp-action-row-marker, .dp-actionbar-wrap-marker { display: none !important; }
...
/* Detail header rows: compact spacing */
[data-testid="stVerticalBlock"]:has(.dp-header-marker) [data-testid="stHorizontalBlock"] {
    gap: 6px !important;
    margin-top: 8px !important;
}
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) {
    width: 100% !important;
    margin-top: 14px !important;
}
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) [data-testid="stHorizontalBlock"],
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) [data-testid="stColumns"] {
...
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) [data-testid="stHorizontalBlock"] > [data-testid="stColumn"],
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) [data-testid="stColumns"] > [data-testid="stColumn"] {
    min-width: 0 !important;
    width: auto !important;
    flex: 0 0 auto !important;
    overflow: visible !important;
...
[data-testid="stVerticalBlock"]:has(.dp-header-marker) [data-testid="stVerticalBlock"]:has(.dp-title-company-block-marker) {
    overflow: visible !important;
}
[data-testid="stVerticalBlock"]:has(.dp-header-marker) .dp-title-company-block {
    display: flex !important;
    flex-direction: column !important;
    gap: 4px !important;
...
[data-testid="stVerticalBlock"]:has(.dp-header-marker) .dp-title-company-block .dp-role-line {
...
[data-testid="stVerticalBlock"]:has(.dp-header-marker) .dp-title-company-block .dp-company-line {
    font-size: 16px !important;
    font-weight: 600 !important;
    color: #374151 !important;
...
/* Close button: styled compact in title row only */
[data-testid="stVerticalBlock"]:has(.dp-header-marker) [data-testid="stHorizontalBlock"]:has(.dp-title-close-row-marker) [data-testid="stColumn"]:last-child [data-testid="stButton"] button {
...
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) [data-testid="stButton"] button {
    width: 100% !important;
    min-height: 42px !important;
    height: 42px !important;
...
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) [data-testid="stColumns"] > [data-testid="stColumn"] > div > div > div > button {
    width: 100% !important;
    min-height: 42px !important;
    height: 42px !important;
    padding: 0 14px !important;
...
[data-testid="stVerticalBlock"]:has(.dp-actionbar-wrap-marker) [data-testid="stButton"] button p {
    white-space: nowrap !important;
    overflow: hidden !important;
    text-overflow: ellipsis !important;
    margin: 0 !important;
...
[data-testid="stColumn"]:has(.detail-panel-marker) [data-testid="stHorizontalBlock"]:not(:has(.dp-actionbar-wrap-marker)),
[data-testid="stColumn"]:has(.detail-panel-marker) [data-testid="stColumns"]:not(:has(.dp-actionbar-wrap-marker)) {
    display: flex !important;
    flex-direction: row !important;
    flex-wrap: nowrap !important;
    gap: 6px !important;
...
[data-testid="stColumn"]:has(.detail-panel-marker) [data-testid="stHorizontalBlock"]:not(:has(.dp-actionbar-wrap-marker)) > [data-testid="stColumn"],
[data-testid="stColumn"]:has(.detail-panel-marker) [data-testid="stColumns"]:not(:has(.dp-actionbar-wrap-marker)) > [data-testid="stColumn"] {
    min-width: 0 !important;
    flex: 1 1 0 !important;
    overflow: hidden !important;
}
...
if st.session_state.get("header_menu_open"):
    with st.container(border=True):
        ...
        _mh1.markdown("**REAL MENU LANGUAGE SOURCE FOUND**")
        if _mh2.button("✕", key="header_menu_close_btn"):
            st.session_state["header_menu_open"] = False
            st.rerun()
        _menu_lang_val = st.session_state["lang"]
        st.caption("LANGUAGE SECTION OVERRIDE TEST")
        _ml1, _ml2 = st.columns(2)
        _ml1.markdown('<span class="header-menu-lang-row-marker"></span>', unsafe_allow_html=True)
        _ml1.button("EN_BUTTON_TEST", key="header_menu_lang_en_test", use_container_width=True)
        _ml2.button("JP_BUTTON_TEST", key="header_menu_lang_jp_test", use_container_width=True)
        st.markdown("---")
        st.markdown("**Me**")
            ...
            with _detail_col:
                ...
                with _dp_hdr:
                    ...
                    with _dph_t:
                        ...
                        st.markdown('<span class="dp-title-company-block-marker"></span>', unsafe_allow_html=True)
                        st.markdown(
                            f'<div class="dp-title-company-block">'
                            f'<div class="dp-role-line">{_dp_role}</div>'
                            f'<div class="dp-company-line">{_dp_company}</div>'
                            f'</div>',
                            unsafe_allow_html=True
                        )
                    with _dph_x:
                    ...
                    with st.container():
                        st.markdown('<span class="dp-actionbar-wrap-marker"></span>', unsafe_allow_html=True)
